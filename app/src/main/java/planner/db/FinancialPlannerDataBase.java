...
public class FinancialPlannerDataBase extends SQLiteOpenHelper {
    ...
    private void createIncomePlannerTable(SQLiteDatabase db) {
        String CREATE_TABLE = "CREATE TABLE INCOMEPLANTABLE(ID BIGINT PRIMARY KEY, DESCRIPTION TEXT, MONTHID BIGINT," +
                "MONTH INTEGER, MONTHNAME TEXT, YEARID BIGINT, YEARNAME INTEGER)";
        db.execSQL(CREATE_TABLE);
    }
    ...
    private void createWalletPlannerTable(SQLiteDatabase db) {
        String CREATE_TABLE = "CREATE TABLE WALLETPLANTABLE(ID BIGINT PRIMARY KEY, NAME TEXT, ICONID BIGINT, ICON INTEGER, ICONNAME TEXT, AMOUNT FLOAT)";
        db.execSQL(CREATE_TABLE);
    }

    private void createCategoryItemTable(SQLiteDatabase db) {
        String CREATE_TABLE = "CREATE TABLE CATEGORYITEMTABLE(ID BIGINT PRIMARY KEY, NAME TEXT, TYPEID BIGINT, TYPE INTEGER, TYPENAME TEXT)";
        db.execSQL(CREATE_TABLE);
    }
