...
public class ExpenseIncomeMonthAdapter extends ArrayAdapter<MonthModal> {
    private static final String TAG = "ExpenseIncomeMonthAdapter";
    private final LayoutInflater mInflater;
    private TextView dropDownItem;
    private List<MonthModal> expenseIncomeModalArrayList;

    public ExpenseIncomeMonthAdapter(Context context, List<MonthModal> expenseIncomeModalArrayList) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        dropDownItem.setText(expenseIncomeModalArrayList.get(position).getName());
        return convertView;
    }
}
